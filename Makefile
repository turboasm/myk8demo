...
APP?=myk8demo
PROJECT=github.com/turboasm/myk8demo
...
MYK8DEMO_LOCAL_HOST?=0.0.0.0
MYK8DEMO_LOCAL_PORT?=8080
MYK8DEMO_LOG_LEVEL?=0
...
run: build
	@echo "+ $@"
	@docker run --name ${CONTAINER_NAME} -p ${MYK8DEMO_LOCAL_PORT}:${MYK8DEMO_LOCAL_PORT} \
		-e "MYK8DEMO_LOCAL_HOST=${MYK8DEMO_LOCAL_HOST}" \
		-e "MYK8DEMO_LOCAL_PORT=${MYK8DEMO_LOCAL_PORT}" \
		-e "MYK8DEMO_LOG_LEVEL=${MYK8DEMO_LOG_LEVEL}" \
